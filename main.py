...
if __name__ == '__main__':
    ...
    # Original dataset
    #sc.loadDataset('C:/Users/green/Pictures/DATA/split_dataset/', 200, 200)
    #sc.createModel()
    #sc.trainModel('my_model')
    #sc.classify('C:/Users/green/PycharmProjects/stemClassifier/my_model', 'C:/Users/green/Pictures/DATA/test/')

    # Simplified dataset
    # sc.loadDataset('C:/Users/green/Pictures/DATA/simplified_roi_dataset/shuffled/', 400, 400)
    # sc.createModel()
    ...
    #sc.classify('C:/Users/green/PycharmProjects/stemClassifier/resnet50_model', 'C:/Users/green/Pictures/DATA/simplified_roi_dataset/test_set/')
